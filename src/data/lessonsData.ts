...
export const lessonsData: Lesson[] = [
  ...
  // ==========================================
  {
    ...
    quiz: [
      {
        id: 'q-1-1',
        hint: 'Нужна команда, которая выводит текст файла целиком на экран (её имя — сокращение от «concatenate»). pwd показывает путь, touch создаёт файл.',
      ...
      {
        id: 'q-1-2',
        hint: 'Родительский каталог обозначается двумя точками. / — это корень всей системы, ~ — домашняя папка.',
      ...
      {
        id: 'q-1-3',
        hint: 'Слэш в начале — абсолютный путь от корня. Без слэша путь считается относительно текущей папки.',
      ...
      {
        id: 'q-1-4',
        hint: 'Обычный ls печатает только имена. Нужен «длинный» (long) формат вывода — один короткий буквенный флаг.',
...
kill -9 PID          # принудительно убить процесс`
    ...
    quiz: [
      {
        id: 'q-2-1',
        hint: 'Права — это тройки r/w/x: владелец, группа, все остальные. x файлу даёт одно, а папке — другое.',
      ...
      {
        id: 'q-2-2',
        hint: 'Считай колонки ps aux слева направо: USER, PID, %CPU, %MEM, VSZ, STAT, START, TIME, COMMAND.',
      ...
      {
        id: 'q-2-3',
        hint: 'Обычный kill посылает SIGTERM (просьба завершиться корректно), -9 — SIGKILL, которую процесс игнорировать не может.',
      ...
      {
        id: 'q-2-4',
        hint: 'Пайп соединяет две программы: стандартный вывод первой становится стандартным вводом второй.',
...
ssh -T -p 2222 git@git-ssh.21-school.ru   # проверка связи: "Welcome, @breashee!"`
    ...
    quiz: [
      {
        id: 'q-3-1',
        hint: 'Логика коробки: сначала положить файлы в индекс, потом упаковать в коммит, потом отправить на сервер.',
      ...
      {
        id: 'q-3-2',
        hint: 'Нужна команда переключения с флагом создания новой ветки (-b).',
      ...
      {
        id: 'q-3-3',
        hint: 'В Git нельзя то, что можно собрать из исходников, и то, что тяжёлое: .o, a.out, бинарники, архивы.',
      ...
      {
        id: 'q-3-4',
        hint: 'master в Школе 21 защищён и используется для проверки, писать нужно туда, куда разрешено.',
...
int main(void) {
  ...
  return 0;
    ...
    quiz: [
      {
        id: 'q-4-1',
        hint: '-W превращает предупреждения компилятора в... что-то более серьёзное.',
...
int main(void) {
  ...
  return 0;
    ...
    quiz: [
      {
        id: 'q-5-1',
        hint: 'В printf для double — %f, а в scanf двойная точность требует буквы длины перед f (как и у long long — %lld).',
      ...
      {
        id: 'q-5-2',
        hint: 'scanf считает не байты и не символы, а количество успешно разобранных элементов форматной строки.',
      ...
      {
        id: 'q-5-3',
        hint: 'Ловушка читает всё, что осталось после числа. Если мусор есть — количество прочитанных станет больше одного.',
...
int main(void) {
  ...
  return 0;
    ...
    quiz: [
      {
        id: 'q-6-1',
        hint: '&& истинно только когда истинны обе части. Проверь правую: 3 > 10.',
...
int main(void) {
  ...
  return 0;
    ...
    quiz: [
      {
        id: 'q-7-1',
        hint: 'Если условие больше никогда не меняется, цикл никогда не завершится.',
      ...
      {
        id: 'q-7-2',
        hint: 'Целочисленное деление просто отбрасывает дробную часть, округления в большую сторону не будет.',
      ...
      {
        id: 'q-7-3',
        hint: '% — это остаток от деления. 7 = 2 * 3 + ? (вспомни про «ловушку» для чётности).',
...
int main(void) {
  ...
  return 0;
    ...
    quiz: [
      {
        id: 'q-8-1',
        hint: 'Компилятор читает файл сверху вниз и обязан увидеть объявление функции до места вызова.',
...
int main(void) {
  ...
  return 0;
    ...
    quiz: [
      {
        id: 'q-9-1',
        hint: 'Линкер подключает библиотеки к тем объектам, которые уже перечислены слева от неё.',
      ...
      {
        id: 'q-9-2',
        hint: 'Дробные числа хранятся с погрешностью: 0.1 + 0.2 может быть не равно 0.3. Сравнивают разность с эпсилон.',
...
int main(void) {
  ...
  return 0;
    ...
    quiz: [
      {
        id: 'q-10-1',
        hint: 'Каждый рекурсивный вызов кладёт кадр в стек вызовов, а стек конечен.',
      ...
      {
        id: 'q-10-2',
        hint: 'Одна часть останавливает рекурсию, вторая — уменьшает задачу, приближая её к остановке.',
...
int main(void) {
  ...
  return 0;
    ...
    quiz: [
      {
        id: 'q-11-1',
        hint: 'Заглавные буквы идут раньше строчных, между ними ровно 32. Код «A» начинается с 6...',
...
int main(void) {
  ...
  return 0;
    ...
    quiz: [
      {
        id: 'q-12-1',
        hint: 'Делители стоят парами: если один больше sqrt(n), второй обязательно меньше — дальше пары только повторяются.',
